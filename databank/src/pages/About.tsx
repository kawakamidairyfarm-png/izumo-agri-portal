  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <section className="mt-6 rounded-2xl bg-white border border-cream-200 shadow-card overflow-hidden">
        {photo && <img decoding="async" src={photo} alt={PHOTOS.about ? '川上哲也' : '川上牧場'} className="aspect-[4/3] w-full object-cover object-[center_35%]" />}
        <div className="p-6">
      ...
      <div className="mt-8 space-y-8 leading-relaxed text-ink-700">
        ...
        <section>
          ...
          <ol className="mt-2 list-decimal pl-5 space-y-1.5">
            ...
            <li>noteで無料公開されている記事の本文を、配信ごとの全文として取り込んでいます（現在 {stats.withText} 本。有料・メンバーシップ限定の記事は載せていません）。</li>
            <li>要約つきの回は現在 {stats.withSummary} 本。podyの記事の「まとめ」を要約として先頭に出し、うち {stats.articles} 本には要約・要点・Q&A・実体験・注意点を編集して添えています。</li>
            <li>全文検索では、文字起こしの誤変換（楽能→酪農、乳腺炎→乳房炎 など）を吸収して探せるようにしています。</li>
            <li>読まれ方を知るために、表示されたページと押されたリンクの数を数えています。名前・メールアドレス・端末を特定する情報は集めず、クッキーも使いません。</li>
          </ol>
        </section>
