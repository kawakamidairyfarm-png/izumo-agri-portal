    ...
    <div className="relative overflow-hidden bg-white p-6 md:p-8 pop-card flex flex-col col-span-1 h-full rounded-3xl">
      ...
      <div className="space-y-6 flex-grow flex flex-col justify-center relative z-10">
        ...
        <div className="bg-white rounded-2xl p-4 border-2 border-slate-800 shadow-sm transition-transform focus-within:-translate-y-1 focus-within:shadow-pop">
          ...
          <div className="flex items-center">
            <input
              ...
              className="block w-full text-right outline-none bg-transparent text-4xl font-black text-slate-800 placeholder-slate-200"
              placeholder="0"
            />
            <span className="ml-2 text-slate-500 font-bold">時間</span>
          </div>
        </div>
        ...
        <div className="bg-coral-DEFAULT rounded-2xl p-6 border-2 border-slate-800 shadow-pop relative overflow-hidden transform rotate-1 hover:rotate-0 transition-transform">
          ...
          <p className="text-sm font-black text-white opacity-90 mb-2 tracking-wider">これまでの対価（目安）</p>
          
          <div className="bg-white rounded-xl p-4 border-2 border-slate-800 shadow-inner flex items-baseline gap-1 mt-1 text-slate-900">
            <span className="text-3xl font-black text-teal-dark">¥</span>
            <span className="text-5xl sm:text-6xl font-black tracking-tighter text-teal-dark drop-shadow-sm">
