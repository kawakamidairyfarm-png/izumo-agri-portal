    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-md">
      ...
      >
        ...
        <div className="p-6 sm:p-8 border-b-4 border-slate-800 flex justify-between items-center bg-coral-light/30 relative z-10">
          <div>
            <h2 className="text-2xl sm:text-3xl font-black text-slate-800 tracking-tight leading-tight">活動の報告</h2>
        ...
        <div className="p-6 sm:p-8 overflow-y-auto relative z-10 bg-white custom-scrollbar">
          <form onSubmit={handleSubmit} className="space-y-7">
            <div>
              <label className="block text-sm font-black text-slate-800 mb-2.5 uppercase tracking-wide">氏名</label>
              <input 
                type="text" 
                required
            ...
            <div>
              <label className="block text-sm font-black text-slate-800 mb-2.5 uppercase tracking-wide">活動日</label>
              <input 
                type="date" 
                required
                className="w-full px-5 py-3.5 bg-white border-2 border-slate-400 rounded-2xl focus:ring-0 focus:border-teal-DEFAULT focus:outline-none transition-all font-bold text-slate-800 shadow-[3px_3px_0px_0px_rgba(148,163,184,1)] focus:shadow-[5px_5px_0px_0px_rgba(45,212,191,1)]"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-black text-slate-800 mb-2.5 uppercase tracking-wide">開始時間</label>
                <input 
                  type="time" 
                  required
                  className="w-full px-5 py-3.5 bg-white border-2 border-slate-400 rounded-2xl focus:ring-0 focus:border-teal-DEFAULT focus:outline-none transition-all font-bold text-slate-800 shadow-[3px_3px_0px_0px_rgba(148,163,184,1)] focus:shadow-[5px_5px_0px_0px_rgba(45,212,191,1)]"
              ...
              <div>
                <label className="block text-sm font-black text-slate-800 mb-2.5 uppercase tracking-wide">終了時間</label>
                <input 
                  type="time" 
                  required
                  className="w-full px-5 py-3.5 bg-white border-2 border-slate-400 rounded-2xl focus:ring-0 focus:border-teal-DEFAULT focus:outline-none transition-all font-bold text-slate-800 shadow-[3px_3px_0px_0px_rgba(148,163,184,1)] focus:shadow-[5px_5px_0px_0px_rgba(45,212,191,1)]"
            ...
            <div>
              <label className="block text-sm font-black text-slate-800 mb-2.5 uppercase tracking-wide">気づき・学んだこと</label>
              <textarea 
                rows={3} 
                required
